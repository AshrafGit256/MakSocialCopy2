          ...
          {activeTab === 'Chat' && (
            <div className="flex gap-2 p-1 bg-white/5 rounded-xl border border-white/5">
              <button 
                ...
                className={`flex-1 py-3 rounded-lg text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all ${chatType === 'Private' ? 'bg-[#10918a]/20 text-[#10918a] border border-[#10918a]/30' : 'text-slate-500 hover:text-slate-300'}`}
              >
                <Lock size={12}/> Private
              </button>
              <button 
                onClick={() => setChatType('Group')}
                className={`flex-1 py-3 rounded-lg text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all ${chatType === 'Group' ? 'bg-[#10918a]/20 text-[#10918a] border border-[#10918a]/30' : 'text-slate-500 hover:text-slate-300'}`}
              >
                <Users size={12}/> Group
              </button>
            </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-slate-500 truncate italic font-medium">
                    {chat.unreadCount > 0 ? <span className="text-[#10918a] not-italic font-bold tracking-tight">new signal...</span> : chat.lastMessage}
                  </p>
                </div>
      ...
      <main className="flex-1 flex flex-col min-w-0 h-full relative bg-[#0d1117]">
        {activeChat ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center opacity-10 space-y-6">
            ...
            <h2 className="text-4xl font-black uppercase italic tracking-tighter">Awaiting Signal</h2>
          </div>
        )}
      </main>
