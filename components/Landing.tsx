  ...
  return (
    <div className="min-h-screen bg-[#05080c] text-white flex flex-col overflow-x-hidden selection:bg-indigo-500/30">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
         ...
         <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-rose-600/5 blur-[150px] rounded-full animate-pulse opacity-50"></div>
      </div>
      ...
      <nav className="px-12 py-8 flex items-center justify-between sticky top-0 z-50 backdrop-blur-xl border-b border-white/5 bg-[#05080c]/60">
        <div className="flex items-center gap-3 group cursor-pointer">
          <img src="https://raw.githubusercontent.com/AshrafGit256/MakSocialImages/main/Public/MakSocial10.png" alt="MakSocial Logo" className="w-14 h-14 group-hover:scale-110 transition-transform" />
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6 relative py-32 lg:py-48">
        ...
        <div className="mt-32 w-full max-w-6xl grid grid-cols-2 md:grid-cols-4 gap-8 px-6 animate-in fade-in duration-1000 delay-500">
           {[
             ...
             <div key={i} className="p-8 rounded-[2rem] bg-white/5 border border-white/10 backdrop-blur-sm group hover:bg-indigo-600/10 transition-all cursor-default">
         ...
         <div className="max-w-7xl mx-auto space-y-32">
            <div className="flex flex-col md:flex-row items-end justify-between gap-10">
               <div className="space-y-6">
                  ...
                  <p className="text-slate-400 text-lg max-w-xl font-medium">Move beyond basic interaction. Access specialized vaults, live ceremony broadcasts, and discipline-specific hubs.</p>
               </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
               {[
                 { title: 'Neural Hubs', desc: 'Isolated college environments to focus on specific academic pulses and career signals.', icon: <Brain size={48} />, badge: 'WING PROTOCOL' },
                 { title: 'Market Sync', desc: 'Real-time transmission of internships, collaborative projects, and freelance node requests.', icon: <Target size={48} />, badge: 'OPPORTUNITY' },
                 { title: 'Registry Control', desc: 'Admins maintain total node oversight with high-level diagnostic tools and forensic logs.', icon: <ShieldCheck size={48} />, badge: 'GOVERNANCE' }
               ].map((feat, i) => (
                 <div key={i} className="group p-12 rounded-[3.5rem] bg-white/[0.02] hover:bg-white/[0.04] border border-white/5 hover:border-indigo-500/30 transition-all relative overflow-hidden">
                    ...
                    <div className="w-20 h-20 bg-indigo-600/10 rounded-[2rem] flex items-center justify-center mb-8 border border-indigo-500/20 group-hover:scale-110 transition-all">
                       {React.cloneElement(feat.icon as React.ReactElement, { size: 32, className: 'text-indigo-500' })}
                    </div>
      ...
      <footer className="px-12 py-24 border-t border-white/5 bg-black/60 backdrop-blur-3xl">
         <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
            <div className="col-span-1 md:col-span-2 space-y-10">
               ...
               <p className="text-slate-500 text-lg max-w-sm leading-relaxed font-medium">The official digital stratum of Makerere University. Handcrafted for the leaders of tomorrow.</p>
