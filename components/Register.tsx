    ...
    <div className="flex h-screen bg-[var(--bg-primary)] overflow-hidden selection:bg-indigo-500 selection:text-white">
      ...
      <div className="hidden lg:block w-1/2 relative bg-[#0f172a]">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#0f172a] via-[#0f172a]/60 to-transparent p-24 flex flex-col justify-end space-y-10">
           ...
           <p className="text-slate-300 text-xl max-w-md font-medium leading-relaxed italic border-l-4 border-indigo-600 pl-8">
            "Register your identity within the hill's collective network. Every node contributes to the pulse."
           </p>
           ...
           <div className="grid grid-cols-2 gap-6 pt-10">
              <div className="p-6 bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 space-y-2">
                 ...
                 <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Universal access to the repository.</p>
              </div>
              <div className="p-6 bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 space-y-2">
                 <div className="p-2 bg-emerald-600 rounded-lg w-fit text-white"><ShieldCheck size={16}/></div>
                 <h4 className="text-sm font-black text-white uppercase tracking-tighter">Verified Identity</h4>
                 <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Trusted student credentials.</p>
              </div>
           </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-[#0f172a] relative overflow-y-auto no-scrollbar">
        <div className="absolute top-10 right-10">
           <button onClick={onSwitchToLogin} className="text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-indigo-600 transition-all">Existing Identity? Sign In</button>
        </div>
        ...
        <div className="w-full max-w-md py-12 space-y-12 animate-in slide-in-from-left-10 duration-700">
          <div className="space-y-4 text-center md:text-left">
            ...
            <h2 className="text-4xl font-black text-[var(--text-primary)] uppercase tracking-tight italic">Initialize <br />Your Node.</h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              Commit Identity <ArrowRight size={18} />
            </button>
          </form>
          
          <div className="pt-8 border-t border-[var(--border-color)] text-center">
             <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">
               By committing your identity, you agree to the Hill Protocol.
             </p>
          </div>
        </div>
      </div>
