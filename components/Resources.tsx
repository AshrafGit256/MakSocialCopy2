...
const Resources: React.FC = () => {
  ...
  const handleAddResource = () => {
    ...
    alert("Success: File uploaded to the Vault.");
  };
      ...
      <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-md mb-8 divide-y divide-[var(--border-color)] overflow-hidden shadow-sm">
        <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
          <div className="flex flex-col gap-1.5">
            <label className="text-[16px] font-bold text-slate-500 uppercase">College</label>
            <select 
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[16px] font-bold text-slate-500 uppercase">Course</label>
            <select 
              className="bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-sm px-3 py-2 text-[16px] font-medium text-[var(--text-primary)] outline-none cursor-pointer"
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[16px] font-bold text-slate-500 uppercase">Year</label>
            <select 
              className="bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-sm px-3 py-2 text-[16px] font-medium text-[var(--text-primary)] outline-none cursor-pointer"
              value={selectedYear}
      ...
      <div className="bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-md overflow-hidden relative shadow-sm">
        ...
        <div className="hidden md:block overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[var(--bg-secondary)] text-[16px] font-bold text-slate-500 uppercase border-b border-[var(--border-color)]">
              ...
              {filteredResources.length > 0 ? filteredResources.map(res => (
                  ...
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[14px] font-medium text-slate-500">{res.course}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-5">
                ...
                <tr>
                  <td colSpan={5} className="py-24 text-center space-y-4">
                    ...
                    <p className="text-[16px] font-bold text-slate-500 uppercase">No files found</p>
                  </td>
                </tr>
              )}
            </tbody>
           ...
           <div className="bg-[var(--bg-primary)] w-full max-w-lg p-8 rounded-md shadow-2xl space-y-6 border border-[var(--border-color)] max-h-[90vh] overflow-y-auto no-scrollbar">
              <div className="flex justify-between items-center border-b border-[var(--border-color)] pb-4">
                 <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-[20px] font-bold text-[var(--text-primary)] uppercase">Upload New File</h2>
                 </div>
              ...
              <div className="space-y-4">
                 <div className="space-y-2">
                    <label className="text-[16px] font-bold text-slate-500 uppercase ml-1">1. Select File</label>
                    <button 
                    ...
                    >
                       ...
                       <span className="text-[16px] font-bold">{addForm.fileName || 'Click to upload file'}</span>
                    </button>
